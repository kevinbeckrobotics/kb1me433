...
void init_mpu6050(void) {
    ...
    write_byte_I2C1(IMU_ADDR, CONFIG, 0x07);
    ...
    write_byte_I2C1(IMU_ADDR,ACCEL_CONFIG,0x1C); // 0x0: +/- 2g, no self-tests
    ...
    write_byte_I2C1(IMU_ADDR,GYRO_CONFIG,0x1C); // 0x0C: +/- 2000 dps, no self-tests
